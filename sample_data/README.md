...
|---|---|---|
| `golden/totalizer_summed.csv` | A cumulative idle-time totalizer a dashboard **sums** instead of differencing. Stair-step export, no reset. | **87,000 naive vs 24,000 honest** |
...
| `golden/two_day.csv` | Clean 2-day event data proving daily grouping does not leak across days. | day-1 Running 1800 + Idle 600; day-2 Running 1200 + Idle 300 |
